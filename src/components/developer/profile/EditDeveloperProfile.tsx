...
const EditDeveloperProfile = () => {
  ...
  return (
    <motion.div className="w-full max-w-5xl mx-auto py-6 lg:py-10 px-4 sm:px-6 md:px-8" variants={containerVariants} initial="hidden" animate="visible">
      <motion.h1 className="text-3xl sm:text-4xl font-bold bg-gradient-to-r from-white to-gray-400 bg-clip-text text-transparent mb-6 sm:mb-8 mt-16 lg:mt-0" variants={itemVariants}>
        Edit Profile
      </motion.h1>
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6 sm:space-y-8">
        <motion.div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 md:gap-8" variants={itemVariants}>
                ...
                <div {...getProfileImageProps()}>
                  ...
                  <motion.div 
                    className={`relative overflow-hidden rounded-full border-2 ${
                      isProfileDragActive ? 'border-purple-500/50' : 'border-white/10'
                    } transition-colors w-32 h-32 bg-gradient-to-br from-purple-900/20 to-black/20 backdrop-blur-xl`}
                  >
                    {profileImage || profile?.profilePicture ? (
                      <div className="relative h-full">
                        ...
                        <motion.button
                          ...
                          className="absolute -top-1 -right-1 p-1.5 bg-rose-500/80 backdrop-blur-xl rounded-full text-white shadow-lg"
                        >
                      ...
                      <div className="h-full flex flex-col items-center justify-center">
                        <ImageIcon className="w-8 h-8 text-purple-400/80 mb-2" />
                        <p className="text-gray-400 text-xs text-center px-2">Click to upload</p>
                      </div>
                    )}
                  </motion.div>
                </div>
          ...
          <div className={sectionClassName}>
            ...
            >
              <div {...getResumeProps()}>
                ...
                <motion.div className={`relative overflow-hidden rounded-xl border-2 ${isResumeDragActive ? 'border-purple-500/50' : 'border-white/10'} transition-colors h-32 bg-gradient-to-br from-purple-900/20 to-black/20 backdrop-blur-xl`}>
                  {resume || profile?.resume ? (
                    <div className="h-full flex items-center p-4 relative">
                      <div className="w-16 h-20 mr-4 bg-white/5 rounded-xl flex items-center justify-center">
                        <FileText className="w-8 h-8 text-purple-400/80" />
                      </div>
                      ...
                      <motion.button
                        ...
                        className="absolute top-2 right-2 p-1.5 bg-rose-500/80 backdrop-blur-xl rounded-full text-white shadow-lg"
                      >
                        <X className="w-3.5 h-3.5" />
                      </motion.button>
                    </div>
                    ...
                    <div className="h-full flex items-center p-4">
                      ...
                      <div className="flex-1">
                        <p className="text-white text-sm font-medium">Upload resume (PDF)</p>
        ...
        <motion.div className="flex justify-center sm:justify-end" variants={itemVariants}>
          <button
            type="submit"
            disabled={isUpdating}
            className="w-full sm:w-auto px-6 sm:px-8 py-3 sm:py-4 bg-gradient-to-r from-purple-600 to-purple-800 text-white rounded-xl hover:from-purple-700 hover:to-purple-900 transition-all disabled:opacity-50 disabled:cursor-not-allowed shadow-lg shadow-purple-900/20 hover:shadow-xl hover:shadow-purple-900/30"
          >
            {isUpdating ? (
