...
import { useDefaultAvailabilityManagement } from '@/hooks/slot/useDefaultAvailabilityManagement';
...
export default function DefaultAvailabilityManagement() {
  const {
    isLoading,
    ...
    toggleAllSlots,
    getAllTimeSlots
  } = useDefaultAvailabilityManagement();
    ...
    return (
      <div className="fixed inset-0 bg-black/90 flex items-center justify-center z-50">
        <div className="relative">
          ...
          <LoadingSpinner
            text='Loading default slot availability...'
            bgColor='dark'
          />
        </div>
      </div>
  ...
  return (
    <div className="w-full max-w-4xl mx-auto flex-1 flex flex-col px-4 sm:px-6 py-4 lg:py-4">
      <motion.div 
        initial={{ opacity: 0, y: -20 }}
        animate={{ opacity: 1, y: 0 }}
        className="backdrop-blur-xl bg-black/80 border-b border-white/5 px-4 py-6 rounded-t-xl"
      >
        <motion.h1 
              ...
              <div className="space-y-6">
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 sm:gap-0">
                  <div className="text-sm text-zinc-400 flex items-center gap-2">
                    ...
                    Set default unavailable time slots for all days
                  </div>
                      ...
                      return (
                        <button
                          ...
                          className={cn(
                            ...
                            {
                              'bg-green-500/20 border-green-500/40 text-green-300': slot.available,
                              'bg-gray-500/20 border-gray-500/40 text-gray-300': !slot.available
                            }
                          )}
                        >
