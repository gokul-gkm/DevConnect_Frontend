...
export function SessionHistory() {
        ...
        return (
          <div className="flex items-center gap-2 lg:gap-3 min-w-0">
            <img
              ...
              alt={developer.name}
              className="w-8 h-8 lg:w-10 lg:h-10 xl:w-12 xl:h-12 rounded-xl lg:rounded-xl object-cover ring-2 ring-purple-500/20 flex-shrink-0"
            />
  ...
  const statsData = [
    {
      ...
      value: stats.total,
      icon: <History className="w-4 h-4 sm:w-5 sm:h-5 lg:w-6 lg:h-6 text-blue-400" />,
    ...
    },
    {
      ...
      icon: <AlertCircle className="w-4 h-4 sm:w-5 sm:h-5 lg:w-6 lg:h-6 text-red-400" />,
  ...
  const SessionCard = ({ session, index }: { session: HistorySession; index: number }) => {
    const statusConfig = {
      completed: {
        label: 'Completed',
        classes: 'bg-green-500/10 text-green-400 border-green-500/20',
      ...
      >
          ...
          <div className="flex items-center gap-2 sm:gap-3 min-w-0 flex-1">
            <div className="relative">
              <img
                ...
                className="w-10 h-10 sm:w-12 sm:h-12 lg:w-14 lg:h-14 rounded-xl object-cover ring-2 ring-purple-500/20 flex-shrink-0"
              />
        ...
        <div className="grid grid-cols-2 gap-2 sm:gap-3 lg:gap-4 mb-3 sm:mb-4">
          <div className="bg-white/5 rounded-xl sm:rounded-xl p-2 sm:p-3 border border-white/5">
            ...
            <p className="text-[10px] sm:text-xs text-gray-500 mt-0.5">{formatDistance(session.date, new Date(), { addSuffix: true })}</p>
          </div>
          ...
          <div className="bg-white/5 rounded-xl sm:rounded-xl p-2 sm:p-3 border border-white/5">
            <div className="flex items-center gap-1.5 sm:gap-2 mb-1">
              ...
              <p className="text-[10px] sm:text-xs text-gray-400">Amount</p>
            </div>
    ...
    <main className="w-full min-h-screen bg-black">
      <div className="h-full px-3 sm:px-4 md:px-6 lg:px-8 xl:px-12 2xl:px-16 py-4 sm:py-6 md:py-8 lg:py-12 pt-16 sm:pt-20 md:pt-24">
        <div className="max-w-[1600px] mx-auto space-y-4 sm:space-y-6 lg:space-y-8">
          ...
          {/* Page Header - Hidden on mobile, visible on tablet+ */}
          <motion.div
            initial={{ opacity: 0, y: -20 }}
            animate={{ opacity: 1, y: 0 }}
            className="hidden sm:block"
          >
            <h1 className="text-2xl md:text-3xl lg:text-4xl font-bold bg-gradient-to-r from-white via-purple-200 to-purple-400 bg-clip-text text-transparent mb-1 md:mb-2">
              Session History
            </h1>
            <p className="text-sm md:text-base text-gray-400">Track and review your past mentoring sessions</p>
          </motion.div>
            ...
            <div className="p-3 sm:p-4 md:p-5 lg:p-6 border-b border-white/5 bg-white/[0.02]">
              <div className="flex flex-col gap-3 sm:gap-4">
                ...
                <div className="sm:hidden">
                  ...
                  <p className="text-xs text-gray-400 mt-0.5">View your past sessions</p>
                </div>
                ...
                <div className="hidden sm:flex flex-col lg:flex-row justify-between items-start lg:items-center gap-3 lg:gap-4">
                  <div>
                    ...
                    <p className="text-xs md:text-sm text-gray-400 mt-1">Review your mentoring history</p>
                  </div>
                </div>
                ...
                <div className="flex flex-col sm:flex-row items-stretch gap-2 sm:gap-3">
                  ...
                  <div className="relative flex-1 sm:max-w-sm lg:max-w-md">
                    <Search className={cn(
                      "absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 sm:w-4 sm:h-4 transition-colors pointer-events-none",
              ...
              <AnimatePresence mode="wait">
                {filteredSessions.length === 0 ? (
                  ...
                  >
                    ...
                    <p className="text-sm sm:text-base text-gray-400">No session history found</p>
