        ...
        return (
            ...
            >
                <div className="text-center p-8 rounded-xl bg-zinc-900/50 backdrop-blur-md shadow-xl border border-zinc-800/50 max-w-md">
                    ...
                    <p className="text-zinc-400">Select a chat from the sidebar to start messaging with developers</p>
                </div>
            </motion.div>
        );
    }
                ...
                <AnimatePresence>
                    {messages
                        ...
                        >
                            ...
                            <div className={`max-w-[70%] ${message.senderType === 'user' ? 'ml-auto' : 'mr-auto'}`}>
