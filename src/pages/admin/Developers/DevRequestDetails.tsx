...
import { Mail, Phone, Github, Linkedin, Globe, Twitter, ExternalLink, Calendar, Award, Code, Briefcase, GraduationCap, Building, FileText } from 'lucide-react';
...
export default function DevRequestDetails() {
    ...
    if (isLoading) {
        return (
            <LoadingSpinner
                size="lg"
                text="Loading developer request..."
                color="indigo"
                fullScreen={true}
            />
        );
        ...
        return (
            <div className="min-h-screen bg-slate-950 flex items-center justify-center">
                <div className="bg-slate-900/70 p-8 rounded-xl border border-red-500/20 backdrop-blur-md shadow-lg">
                    <p className="text-red-400 text-lg font-semibold">Failed to load developer request details</p>
    ...
    return (
        <div className="min-h-screen bg-gradient-to-b from-slate-950 to-slate-900 p-4 md:p-8">
            ...
            >
                    ...
                    <div className="px-5 sm:px-7 py-6 -mt-16 relative z-10">
                        <div className="flex flex-col md:flex-row gap-4 md:gap-6 md:items-center">
                            <div className="relative group">
                                <div className="absolute inset-0 bg-gradient-to-r from-yellow-500/20 to-amber-500/20 rounded-full blur-md opacity-70 group-hover:opacity-100 transition-opacity duration-300"></div>
                            <div className="relative">
                                    <div className="w-32 h-32 sm:w-36 sm:h-36 rounded-full p-[3px] bg-gradient-to-r from-yellow-500 to-amber-500 shadow-xl">
                                <img
                                ...
                                <Badge
                                        className="absolute -top-2 -right-2 shadow-md bg-yellow-500/20 text-yellow-400 border-yellow-500/30 hover:bg-yellow-500/30"
                                >
                                    Pending
                                </Badge>
                                </div>
                                ...
                                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                                    <div>
                                        ...
                                        <p className="text-slate-400 mt-1 flex items-center gap-2">
                                            <Briefcase className="h-4 w-4 text-yellow-400" /> {developer.workingExperience.jobTitle}
                                        </p>
                                        <p className="text-slate-400 mt-1 flex items-center gap-2">
                                            <Mail className="h-4 w-4 text-yellow-400" /> {developer.userId.email}
                                        </p>
                                    </div>
                                    <div className="flex gap-3 mt-3 sm:mt-0">
                                        <Button 
                                            onClick={handleApprove}
                                            className="bg-green-500/10 text-green-400 border border-green-500/30 hover:bg-green-500/20 rounded-full px-5 shadow-md transition-all duration-300"
                                        >
                                            Approve
                                        </Button>
                                        <Button 
                                            onClick={() => setIsRejectDialogOpen(true)}
                                            className="bg-red-500/10 text-red-400 border border-red-500/30 hover:bg-red-500/20 rounded-full px-5 shadow-md transition-all duration-300"
                                        >
                                            Reject
                                        </Button>
                                    </div>
                                    ...
                                    <div className="flex gap-3 mt-4">
                                        {developer.userId.socialLinks.github && (
                                            <a 
                                                ...
                                                className="text-slate-400 hover:text-yellow-400 transition-colors p-2 bg-slate-800/30 rounded-full"
                                            >
                ...
                >
                    <div className="bg-slate-900/60 rounded-xl border border-slate-800/50 p-5 backdrop-blur-lg shadow-lg hover:bg-slate-900/80 transition-colors duration-200">
                        ...
                        <p className="text-lg font-semibold text-slate-100 mt-2">
                            Application Date: {new Date(developer.createdAt).toLocaleDateString()}
                        </p>
                    </div>
                    <div className="bg-slate-900/60 rounded-xl border border-slate-800/50 p-5 backdrop-blur-lg shadow-lg hover:bg-slate-900/80 transition-colors duration-200">
                        <div className="flex justify-between items-start">
                            <p className="text-sm text-slate-400 font-medium">Proposed Hourly Rate</p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    >
                        ...
                        >
                            <h3 className="text-lg font-semibold text-slate-100 mb-4 flex items-center gap-2">
                                <Award className="h-5 w-5 text-yellow-400" /> About
                            </h3>
                        ...
                        >
                            <h3 className="text-lg font-semibold text-slate-100 mb-4 flex items-center gap-2">
                                <Briefcase className="h-5 w-5 text-yellow-400" /> Professional Information
                            </h3>
                            <div className="grid grid-cols-1 sm:grid-cols-3 gap-5">
                                <div className="bg-slate-800/50 p-4 rounded-xl hover:bg-slate-800/70 transition-colors duration-200 shadow-md">
                                    <div className="flex items-start gap-2">
                                        <Building className="h-5 w-5 text-yellow-400 mt-0.5" />
                                        <div>
                        ...
                        >
                            <h3 className="text-lg font-semibold text-slate-100 mb-4 flex items-center gap-2">
                                <GraduationCap className="h-5 w-5 text-yellow-400" /> Education
                            </h3>
                            <div className="grid grid-cols-1 sm:grid-cols-3 gap-5">
                                <div className="bg-slate-800/50 p-4 rounded-xl hover:bg-slate-800/70 transition-colors duration-200 shadow-md">
                                    <div className="flex items-start gap-2">
                                        <GraduationCap className="h-5 w-5 text-yellow-400 mt-0.5" />
                                <div>
                                ...
                                <div className="bg-slate-800/50 p-4 rounded-xl hover:bg-slate-800/70 transition-colors duration-200 shadow-md">
                                    <div className="flex items-start gap-2">
                                        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-yellow-400 mt-0.5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                        ...
                        >
                            <h3 className="text-lg font-semibold text-slate-100 mb-4 flex items-center gap-2">
                                <Code className="h-5 w-5 text-yellow-400" /> Expertise
                            </h3>
                            <div className="flex flex-wrap gap-2">
                                {developer.expertise.map((skill: string) => (
                                    <Badge
                                        key={skill}
                                        className="bg-yellow-500/10 text-yellow-400 border-yellow-500/30 hover:bg-yellow-500/20 transition-colors duration-200 shadow-sm py-1.5"
                                    >
                                        {skill}
                                    </Badge>
                                ))}
                    ...
                    <motion.div variants={itemVariants} className="space-y-6">
                        ...
                        >
                            <h3 className="text-lg font-semibold text-slate-100 mb-4 flex items-center gap-2">
                                <Globe className="h-5 w-5 text-yellow-400" /> Languages
                            </h3>
                            <div className="flex flex-wrap gap-2">
                        ...
                        >
                            <h3 className="text-lg font-semibold text-slate-100 mb-4 flex items-center gap-2">
                                <FileText className="h-5 w-5 text-yellow-400" /> Resume
                            </h3>
                            <a 
                        ...
                        >
                            <h3 className="text-lg font-semibold text-slate-100 mb-4 flex items-center gap-2">
                                <Phone className="h-5 w-5 text-yellow-400" /> Contact Information
                            </h3>
                        ...
                        <motion.div
                            ...
                            className="bg-gradient-to-br from-yellow-600/10 to-amber-600/10 rounded-xl border border-yellow-500/20 p-6 backdrop-blur-md shadow-lg"
                        >
                            <h3 className="text-lg font-semibold text-yellow-100 mb-3">Application Status</h3>
                            <div className="flex items-center gap-2 mb-4">
                                <div className="w-3 h-3 bg-yellow-400 rounded-full animate-pulse"></div>
                                <p className="text-yellow-300 font-medium">Pending Review</p>
                            </div>
                            <div className="flex flex-wrap gap-3">
                                <Button 
                                    onClick={handleApprove}
                                    className="flex-1 bg-green-500/20 hover:bg-green-500/30 text-green-400 border border-green-500/30 rounded-xl shadow-md"
                                >
                                    Approve
                                </Button>
                                <Button 
                                    onClick={() => setIsRejectDialogOpen(true)}
                                    className="flex-1 bg-red-500/20 hover:bg-red-500/30 text-red-400 border border-red-500/30 rounded-xl shadow-md"
                                >
                                    Reject
                                </Button>
                            </div>
            ...
            <RejectDialog
                ...
                title="Reject Developer Application"
